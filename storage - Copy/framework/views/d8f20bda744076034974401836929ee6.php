...
<body class="bg-gray-50 font-inter">
    ...
    <nav class="fixed top-0 w-full bg-white/80 backdrop-blur-md border-b border-gray-200/50 z-50 transition-all duration-300" id="navbar">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    <a href="<?php echo e(route('features')); ?>" class="text-gray-700 hover:text-primary-600 transition-colors duration-200 font-medium">Features</a>
                    <a href="<?php echo e(route('pricing')); ?>" class="text-gray-700 hover:text-primary-600 transition-colors duration-200 font-medium">Pricing</a>
                    <a href="<?php echo e(route('contact')); ?>" class="text-gray-700 hover:text-primary-600 transition-colors duration-200 font-medium">Contact</a>
        ...
        <div class="md:hidden bg-white border-t border-gray-200 hidden" id="mobileMenu">
            <div class="px-4 pt-2 pb-3 space-y-1">
                <a href="<?php echo e(route('features')); ?>" class="block px-3 py-2 text-gray-700 hover:text-primary-600">Features</a>
                <a href="<?php echo e(route('pricing')); ?>" class="block px-3 py-2 text-gray-700 hover:text-primary-600">Pricing</a>
                <a href="<?php echo e(route('contact')); ?>" class="block px-3 py-2 text-gray-700 hover:text-primary-600">Contact</a>
        ...
        <div class="flex items-center justify-center min-h-screen px-4">
            <div class="bg-white rounded-2xl shadow-2xl max-w-md w-full border border-gray-200">
                <div class="p-6">
                    ...
                    <!-- Login Form -->
                    <form id="loginForm" action="<?php echo e(route('login.post')); ?>" method="POST" class="space-y-4">
                        <?php echo csrf_field(); ?>
                            ...
                            <select name="company_slug" id="company_slug" class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-primary-500 focus:ring-0 transition-colors duration-200">
                                ...
                                <?php if(isset($companies) && count($companies) > 0): ?>
                                    <?php $__currentLoopData = $companies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $company): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($company->slug); ?>">
                                            <?php echo e($company->name); ?> (<?php echo e($company->slug); ?>.yourdomain.com)
                                        </option>
    ...
    <section id="register" class="py-20 bg-gradient-to-br from-primary-50 to-primary-100">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <form action="<?php echo e(route('company.register')); ?>" method="POST" class="bg-white rounded-2xl shadow-2xl p-8 lg:p-12">
                <?php echo csrf_field(); ?>
                ...
                <div class="mb-8">
                    ...
                    <div class="grid lg:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="flex">
                                <input type="text" name="company_slug" value="<?php echo e(old('company_slug')); ?>" 
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid lg:grid-cols-4 gap-8 mb-12">
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li><a href="<?php echo e(route('features')); ?>" class="text-gray-400 hover:text-white transition-colors duration-200">Features</a></li>
                        <li><a href="<?php echo e(route('pricing')); ?>" class="text-gray-400 hover:text-white transition-colors duration-200">Pricing</a></li>
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        ...
                        <li><a href="<?php echo e(route('contact')); ?>" class="text-gray-400 hover:text-white transition-colors duration-200">Contact Us</a></li>
...
<?php /**PATH D:\source_code\herbal-ecom\resources\views/landing/index.blade.php ENDPATH**/ ?>