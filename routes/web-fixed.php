...
Route::get('/debug-checkout', [\App\Http\Controllers\DebugController::class, 'debugCheckout']);
Route::get('/admin-test', [\App\Http\Controllers\AdminTestController::class, 'testAdmin']);

// Test admin route without middleware
Route::get('/admin-direct', function() {
    return 'Admin route is working! The issue is with middleware or caching.';
});
Route::get('/admin-dashboard-test', [\App\Http\Controllers\Admin\DashboardController::class, 'index']);
