                ...
                <div class="tab-content" id="v-pills-tabContent">
                    ...
                    <div class="tab-pane fade show active" id="v-pills-company" role="tabpanel">
                        <div class="card shadow">
                            ...
                            <div class="card-body">
                                <form action="<?php echo e(route('admin.settings.company')); ?>" method="POST"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="company_name"
                                                    name="company_name"
                                                    value="<?php echo e($company ? $company->name : 'Herbal Bliss'); ?>" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="email" class="form-control" id="company_email"
                                                    name="company_email"
                                                    value="<?php echo e($company ? $company->email : 'admin@herbalbliss.com'); ?>"
                                                    required>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="company_phone"
                                                    name="company_phone" value="<?php echo e($company ? $company->phone : ''); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="company_address"
                                                    ...
                                                    value="<?php echo e($company ? $company->address : ''); ?>">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="company_city"
                                                    name="company_city" value="<?php echo e($company ? $company->city : ''); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="company_state"
                                                    name="company_state" value="<?php echo e($company ? $company->state : ''); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="company_postal_code"
                                                    ...
                                                    value="<?php echo e($company ? $company->postal_code : ''); ?>">
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="tab-pane fade" id="v-pills-theme" role="tabpanel">
                        <div class="card shadow">
                            ...
                            <div class="card-body">
                                <form action="<?php echo e(route('admin.settings.theme')); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                    ...
                    <div class="tab-pane fade" id="v-pills-delivery" role="tabpanel">
                        <div class="card shadow">
                            ...
                            <div class="card-body">
                                <form action="<?php echo e(route('admin.settings.delivery')); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                            ...
                                            <div class="card-body">
                                                <div class="form-check form-switch mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                                        ...
                                                        value="1" <?php echo e((($deliverySettings['min_order_validation_enabled'] ?? false) ? 'checked' : '')); ?> onchange="toggleMinOrderValidation()">
                                                ...
                                                <div id="min-order-validation-content" style="display: <?php echo e((($deliverySettings['min_order_validation_enabled'] ?? false) ? 'block' : 'none')); ?>;">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" class="form-control"
                                                                    id="min_order_amount"
                                                                    name="min_order_amount" value="<?php echo e($deliverySettings['min_order_amount'] ?? '1000.00'); ?>"
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    value="<?php echo e($deliverySettings['min_order_message'] ?? 'Minimum order amount is ₹1000 for online orders.'); ?>"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="bg-light p-3 rounded">
                                            ...
                                            <?php if($deliverySettings['min_order_validation_enabled'] ?? false): ?>
                                                <div class="mb-1">
                                                    <strong>Min Order:</strong> ₹<?php echo e(number_format($deliverySettings['min_order_amount'] ?? 1000, 0)); ?>
                    ...
                    <div class="tab-pane fade" id="v-pills-pagination" role="tabpanel">
                        <div class="card shadow">
                            ...
                            <div class="card-body">
                                <form action="<?php echo e(route('admin.settings.pagination')); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                    ...
                    <div class="tab-pane fade" id="v-pills-bill-format" role="tabpanel">
                        <div class="card shadow">
                            ...
                            <div class="card-body">
                                <form action="<?php echo e(route('admin.settings.bill-format')); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                                ...
                                                <div class="card-body">
                                                    <div class="form-check form-switch mb-3">
                                                        <input class="form-check-input" type="checkbox" id="thermal_printer_enabled"
                                                            ...
                                                            <?php echo e(($billFormatSettings['thermal_printer_enabled'] ?? false) ? 'checked' : ''); ?>>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control" id="thermal_printer_width" name="thermal_printer_width">
                                                                    <option value="58" <?php echo e(($billFormatSettings['thermal_printer_width'] ?? 80) == 58 ? 'selected' : ''); ?>>58mm</option>
                                                                    <option value="80" <?php echo e(($billFormatSettings['thermal_printer_width'] ?? 80) == 80 ? 'selected' : ''); ?>>80mm (Standard)</option>
                                                                    <option value="112" <?php echo e(($billFormatSettings['thermal_printer_width'] ?? 80) == 112 ? 'selected' : ''); ?>>112mm</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-check form-switch mt-4">
                                                                <input class="form-check-input" type="checkbox" id="thermal_printer_auto_cut"
                                                                    ...
                                                                    <?php echo e(($billFormatSettings['thermal_printer_auto_cut'] ?? true) ? 'checked' : ''); ?>>
                                                ...
                                                <div class="card-body">
                                                    <div class="form-check form-switch mb-3">
                                                        <input class="form-check-input" type="checkbox" id="a4_sheet_enabled"
                                                            ...
                                                            <?php echo e(($billFormatSettings['a4_sheet_enabled'] ?? true) ? 'checked' : ''); ?>>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" id="a4_sheet_orientation" name="a4_sheet_orientation">
                                                            <option value="portrait" <?php echo e(($billFormatSettings['a4_sheet_orientation'] ?? 'portrait') == 'portrait' ? 'selected' : ''); ?>>Portrait</option>
                                                            <option value="landscape" <?php echo e(($billFormatSettings['a4_sheet_orientation'] ?? 'portrait') == 'landscape' ? 'selected' : ''); ?>>Landscape</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" id="default_bill_format" name="default_bill_format" required>
                                                            <option value="thermal" <?php echo e(($billFormatSettings['default_bill_format'] ?? 'a4_sheet') == 'thermal' ? 'selected' : ''); ?>>Thermal Printer</option>
                                                            <option value="a4_sheet" <?php echo e(($billFormatSettings['default_bill_format'] ?? 'a4_sheet') == 'a4_sheet' ? 'selected' : ''); ?>>A4 Sheet PDF</option>
                                                        </select>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-check form-switch mb-3">
                                                        <input class="form-check-input" type="checkbox" id="bill_logo_enabled"
                                                            ...
                                                            <?php echo e(($billFormatSettings['bill_logo_enabled'] ?? true) ? 'checked' : ''); ?>>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-check form-switch mb-3">
                                                        <input class="form-check-input" type="checkbox" id="bill_company_info_enabled"
                                                            ...
                                                            <?php echo e(($billFormatSettings['bill_company_info_enabled'] ?? true) ? 'checked' : ''); ?>>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="bg-light p-3 rounded">
                                            <div class="mb-2">
                                                <strong>Status:</strong>
                                                <?php if($billFormatSettings['thermal_printer_enabled'] ?? false): ?>
                                            ...
                                            <div class="mb-2">
                                                <strong>Width:</strong> <?php echo e($billFormatSettings['thermal_printer_width'] ?? 80); ?>mm
                                            </div>
                                            <div>
                                                <strong>Auto Cut:</strong> 
                                                <?php echo e(($billFormatSettings['thermal_printer_auto_cut'] ?? true) ? 'Yes' : 'No'); ?>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="bg-light p-3 rounded">
                                            <div class="mb-2">
                                                <strong>Status:</strong>
                                                <?php if($billFormatSettings['a4_sheet_enabled'] ?? true): ?>
                                                    <span class="badge bg-success">Enabled</span>
                                                <?php else: ?>
                                                    <span class="badge bg-secondary">Disabled</span>
                                                <?php endif; ?>
                                            ...
                                            <div class="mb-2">
                                                <strong>Orientation:</strong> <?php echo e(ucfirst($billFormatSettings['a4_sheet_orientation'] ?? 'portrait')); ?>

                                            </div>
                                            <div>
                                                <strong>Default Format:</strong> 
                                                <?php echo e(ucfirst(str_replace('_', ' ', $billFormatSettings['default_bill_format'] ?? 'a4_sheet'))); ?>
                                ...
                                <form action="<?php echo e(route('admin.settings.notifications')); ?>" method="POST">
                                    ...
                                    <div class="form-check mb-3">
                                        <input class="form-check-input" type="checkbox" id="email_notifications"
                                            name="email_notifications" value="1" <?php echo e(($notificationSettings['email_notifications'] ?? true) ? 'checked' : ''); ?>>
                                    ...
                                    <div class="form-check mb-3">
                                        <input class="form-check-input" type="checkbox" id="whatsapp_notifications"
                                            name="whatsapp_notifications" value="1" <?php echo e(($notificationSettings['whatsapp_notifications'] ?? false) ? 'checked' : ''); ?>>
                                    ...
                                    <div class="form-check mb-3">
                                        <input class="form-check-input" type="checkbox" id="sound_notifications"
                                            name="sound_notifications" value="1" <?php echo e(($notificationSettings['sound_notifications'] ?? true) ? 'checked' : ''); ?>>
                                    ...
                                    <div class="form-check mb-3">
                                        <input class="form-check-input" type="checkbox" id="popup_notifications"
                                            name="popup_notifications" value="1" <?php echo e(($notificationSettings['popup_notifications'] ?? true) ? 'checked' : ''); ?>>
                                    ...
                                    <div class="form-check mb-3">
                                        <input class="form-check-input" type="checkbox" id="order_notifications"
                                            name="order_notifications" value="1" <?php echo e(($notificationSettings['order_notifications'] ?? true) ? 'checked' : ''); ?>>
                                    ...
                                    <div class="form-check mb-3">
                                        <input class="form-check-input" type="checkbox" id="low_stock_alert"
                                            name="low_stock_alert" value="1" <?php echo e(($notificationSettings['low_stock_alert'] ?? true) ? 'checked' : ''); ?>>
                    ...
                    <div class="tab-pane fade" id="v-pills-animations" role="tabpanel">
                        <div class="card shadow">
                            ...
                            <div class="card-body">
                                ...
                                <form action="<?php echo e(route('admin.settings.animations')); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                        ...
                                        <div class="card-body">
                                            <div class="form-check form-switch mb-3">
                                                <input class="form-check-input" type="checkbox"
                                                    ...
                                                    value="1" <?php echo e((\App\Models\AppSetting::get('frontend_animations_enabled', 'true') === 'true') ? 'checked' : ''); ?>
                                            ...
                                            <div id="animation-settings-content" style="display: <?php echo e((\App\Models\AppSetting::get('frontend_animations_enabled', 'true') === 'true') ? 'block' : 'none'); ?>;">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" id="frontend_animation_intensity"
                                                                ...
                                                                <option value="1" <?php echo e(\App\Models\AppSetting::get('frontend_animation_intensity', '3') == '1' ? 'selected' : ''); ?>>Low (1x)</option>
                                                                <option value="2" <?php echo e(\App\Models\AppSetting::get('frontend_animation_intensity', '3') == '2' ? 'selected' : ''); ?>>Medium (2x)</option>
                                                                <option value="3" <?php echo e(\App\Models\AppSetting::get('frontend_animation_intensity', '3') == '3' ? 'selected' : ''); ?>>High (3x)</option>
                                                                <option value="4" <?php echo e(\App\Models\AppSetting::get('frontend_animation_intensity', '3') == '4' ? 'selected' : ''); ?>>Very High (4x)</option>
                                                                <option value="5" <?php echo e(\App\Models\AppSetting::get('frontend_animation_intensity', '3') == '5' ? 'selected' : ''); ?>>Maximum (5x)</option>
                                                            </select>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" id="frontend_animation_style"
                                                                ...
                                                                <option value="modern" <?php echo e(\App\Models\AppSetting::get('frontend_animation_style', 'crackers') == 'modern' ? 'selected' : ''); ?>>Modern & Smooth</option>
                                                                <option value="crackers" <?php echo e(\App\Models\AppSetting::get('frontend_animation_style', 'crackers') == 'crackers' ? 'selected' : ''); ?>>Crackers & Fireworks</option>
                                                                <option value="festive" <?php echo e(\App\Models\AppSetting::get('frontend_animation_style', 'crackers') == 'festive' ? 'selected' : ''); ?>>Festive & Colorful</option>
                                                                <option value="minimal" <?php echo e(\App\Models\AppSetting::get('frontend_animation_style', 'crackers') == 'minimal' ? 'selected' : ''); ?>>Minimal & Subtle</option>
                                                            </select>
                                    ...
                                    <div class="card bg-light mb-4" id="specific-animations" style="display: <?php echo e((\App\Models\AppSetting::get('frontend_animations_enabled', 'true') === 'true') ? 'block' : 'none'); ?>;">
                                        <div class="card-header">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-check form-switch mb-3">
                                                        <input class="form-check-input" type="checkbox"
                                                            ...
                                                            value="1" <?php echo e((\App\Models\AppSetting::get('frontend_celebration_enabled', 'true') === 'true') ? 'checked' : ''); ?>>
                                                    ...
                                                    <div class="form-check form-switch mb-3">
                                                        <input class="form-check-input" type="checkbox"
                                                            ...
                                                            value="1" <?php echo e((\App\Models\AppSetting::get('frontend_fireworks_enabled', 'true') === 'true') ? 'checked' : ''); ?>>
                                                    ...
                                                    <div class="form-check form-switch mb-3">
                                                        <input class="form-check-input" type="checkbox"
                                                            ...
                                                            value="1" <?php echo e((\App\Models\AppSetting::get('frontend_hover_effects_enabled', 'true') === 'true') ? 'checked' : ''); ?>>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-check form-switch mb-3">
                                                        <input class="form-check-input" type="checkbox"
                                                            ...
                                                            value="1" <?php echo e((\App\Models\AppSetting::get('frontend_loading_animations', 'true') === 'true') ? 'checked' : ''); ?>>
                                                    ...
                                                    <div class="form-check form-switch mb-3">
                                                        <input class="form-check-input" type="checkbox"
                                                            ...
                                                            value="1" <?php echo e((\App\Models\AppSetting::get('frontend_page_transitions', 'true') === 'true') ? 'checked' : ''); ?>>
                                                    ...
                                                    <div class="form-check form-switch mb-3">
                                                        <input class="form-check-input" type="checkbox"
                                                            ...
                                                            value="1" <?php echo e((\App\Models\AppSetting::get('frontend_welcome_animation', 'true') === 'true') ? 'checked' : ''); ?>>
                                    ...
                                    <div class="card bg-warning bg-opacity-10 border-warning mb-4" id="performance-settings" style="display: <?php echo e((\App\Models\AppSetting::get('frontend_animations_enabled', 'true') === 'true') ? 'block' : 'none'); ?>;">
                                        <div class="card-header">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" id="animation_duration" name="animation_duration">
                                                            <option value="300" <?php echo e(\App\Models\AppSetting::get('animation_duration', '600') == '300' ? 'selected' : ''); ?>>Fast (300ms)</option>
                                                            <option value="600" <?php echo e(\App\Models\AppSetting::get('animation_duration', '600') == '600' ? 'selected' : ''); ?>>Normal (600ms)</option>
                                                            <option value="1000" <?php echo e(\App\Models\AppSetting::get('animation_duration', '600') == '1000' ? 'selected' : ''); ?>>Slow (1000ms)</option>
                                                            <option value="1500" <?php echo e(\App\Models\AppSetting::get('animation_duration', '600') == '1500' ? 'selected' : ''); ?>>Very Slow (1500ms)</option>
                                                        </select>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-check form-switch mt-4">
                                                        <input class="form-check-input" type="checkbox"
                                                            ...
                                                            value="1" <?php echo e((\App\Models\AppSetting::get('reduce_motion_respect', 'true') === 'true') ? 'checked' : ''); ?>>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="bg-light p-3 rounded">
                                            <div class="mb-2">
                                                ...
                                                <?php if(\App\Models\AppSetting::get('frontend_animations_enabled', 'true') === 'true'): ?>
                                                    <span class="badge bg-success">Enabled</span>
                                                <?php else: ?>
                                                    <span class="badge bg-secondary">Disabled</span>
                                                <?php endif; ?>
                                            ...
                                            <div class="mb-2">
                                                <strong>Intensity:</strong> <?php echo e(\App\Models\AppSetting::get('frontend_animation_intensity', '3')); ?>x
                                            </div>
                                            <div class="mb-2">
                                                <strong>Style:</strong> <?php echo e(ucfirst(\App\Models\AppSetting::get('frontend_animation_style', 'crackers'))); ?>

                                            </div>
                                            <div>
                                                <strong>Duration:</strong> <?php echo e(\App\Models\AppSetting::get('animation_duration', '600')); ?>ms
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="bg-light p-3 rounded">
                                            <div class="mb-1">
                                                ...
                                                <?php echo e((\App\Models\AppSetting::get('frontend_celebration_enabled', 'true') === 'true') ? '✅' : '❌'); ?>

                                            </div>
                                            <div class="mb-1">
                                                <strong>Fireworks:</strong> 
                                                <?php echo e((\App\Models\AppSetting::get('frontend_fireworks_enabled', 'true') === 'true') ? '🎆' : '❌'); ?>

                                            </div>
                                            <div class="mb-1">
                                                <strong>Hover Effects:</strong> 
                                                <?php echo e((\App\Models\AppSetting::get('frontend_hover_effects_enabled', 'true') === 'true') ? '✅' : '❌'); ?>

                                            </div>
                                            <div>
                                                <strong>Welcome Animation:</strong> 
                                                <?php echo e((\App\Models\AppSetting::get('frontend_welcome_animation', 'true') === 'true') ? '👋' : '❌'); ?>
                        ...
                        <div class="card shadow">
                            ...
                            <div class="card-body">
                                <div class="alert alert-info">
                                    ...
                                    WhatsApp.
                                    You can use placeholders like {{ customer_name }}, {{ order_number }},
                                ...
                                <form action="<?php echo e(route('admin.settings.whatsapp-templates')); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-4">
                                                ...
                                                <textarea class="form-control" id="whatsapp_template_pending" name="whatsapp_template_pending" rows="6"
                                                    maxlength="1000" placeholder="Enter template for pending orders..."><?php if($whatsappSettings['whatsapp_template_pending'] ?? false): ?><?php echo e($whatsappSettings['whatsapp_template_pending']); ?>@elseHello {{ customer_name }},
...
Thank you for choosing {{ company_name }}!<?php endif; ?></textarea>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-4">
                                                ...
                                                <textarea class="form-control" id="whatsapp_template_processing" name="whatsapp_template_processing" rows="6"
                                                    maxlength="1000" placeholder="Enter template for processing orders..."><?php if($whatsappSettings['whatsapp_template_processing'] ?? false): ?><?php echo e($whatsappSettings['whatsapp_template_processing']); ?>@elseHello {{ customer_name }},
...
{{ company_name }}<?php endif; ?></textarea>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-4">
                                                ...
                                                <textarea class="form-control" id="whatsapp_template_shipped" name="whatsapp_template_shipped" rows="6"
                                                    maxlength="1000" placeholder="Enter template for shipped orders..."><?php if($whatsappSettings['whatsapp_template_shipped'] ?? false): ?><?php echo e($whatsappSettings['whatsapp_template_shipped']); ?><?php else: ?>🚚 Hello {{ customer_name }},
...
Thanks for shopping with {{ company_name }}!<?php endif; ?></textarea>
                                                <small class="text-muted">Message sent when order status is set to
                                                    Shipped</small>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-4">
                                                ...
                                                <textarea class="form-control" id="whatsapp_template_delivered" name="whatsapp_template_delivered" rows="6"
                                                    maxlength="1000" placeholder="Enter template for delivered orders..."><?php if($whatsappSettings['whatsapp_template_delivered'] ?? false): ?><?php echo e($whatsappSettings['whatsapp_template_delivered']); ?><?php else: ?>✅ Hello {{ customer_name }},
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-4">
                                                ...
                                                <textarea class="form-control" id="whatsapp_template_cancelled" name="whatsapp_template_cancelled" rows="6"
                                                    maxlength="1000" placeholder="Enter template for cancelled orders..."><?php if($whatsappSettings['whatsapp_template_cancelled'] ?? false): ?><?php echo e($whatsappSettings['whatsapp_template_cancelled']); ?><?php else: ?>❌ Hello {{ customer_name }},
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-4">
                                                ...
                                                <textarea class="form-control" id="whatsapp_template_payment_confirmed" name="whatsapp_template_payment_confirmed"
                                                    rows="6" maxlength="1000" placeholder="Enter template for payment confirmation..."><?php if($whatsappSettings['whatsapp_template_payment_confirmed'] ?? false): ?><?php echo e($whatsappSettings['whatsapp_template_payment_confirmed']); ?><?php else: ?>💳 Hello {{ customer_name }},
                                    ...
                                    <div class="card bg-light mb-4">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <ul class="list-unstyled">
                                                        <li><code>{{ customer_name }}
                                                            ...
                                                            - Customer's name</li>
                                                        <li><code>{{ order_number }}
                                                            </code>
                                                            - Order number</li>
                                                        <li><code>{{ total }}
                                                            </code>
                                                            - Order total amount</li>
                                                        <li><code>{{ company_name }}
                                                            </code>
                                                ...
                                                <div class="col-md-6">
                                                    <ul class="list-unstyled">
                                                        ...
                                                        <li><code>{{ payment_status }}
                                                            </code>
                                                            - Payment status</li>
                                                        <li><code>{{ customer_mobile }}
                                            ...
                                            <small class="text-muted"><i class="fas fa-lightbulb"></i>
                                                ...
                                                {{ customer_name }} for placeholders.</small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="bg-light p-3 rounded">
                                            <div class="mb-2">
                                                ...
                                                <?php if($notificationSettings['whatsapp_notifications'] ?? false): ?>
                                                    <span class="badge bg-success">
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\source_code\herbal-ecom\resources\views/admin/settings/index.blade.php ENDPATH**/ ?>