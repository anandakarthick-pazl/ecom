...
@section('page-title', 'Themes Management')
        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center flex-wrap">
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="{{ route('super-admin.themes.create') }}" class="btn btn-primary">
    ...
    <div class="row mb-4">
        <div class="col-md-3">
            <div class="stats-card bg-gradient-primary text-white">
                <div class="stats-content">
                    <div class="stats-number">{{ $themes->total() }}</div>
        ...
        <div class="col-md-3">
            <div class="stats-card bg-gradient-success text-white">
                <div class="stats-content">
                    <div class="stats-number">{{ $themes->where('status', 'active')->count() }}</div>
        ...
        <div class="col-md-3">
            <div class="stats-card bg-gradient-info text-white">
                <div class="stats-content">
                    <div class="stats-number">{{ $themes->where('is_free', true)->count() }}</div>
        ...
        <div class="col-md-3">
            <div class="stats-card bg-gradient-warning text-white">
                <div class="stats-content">
                    <div class="stats-number">{{ $themes->where('is_free', false)->count() }}</div>
    ...
    @if($themes->count() > 0)
        <div class="themes-grid" id="themesGrid">
            ...
            <div class="theme-card" 
                 ...
                 data-layout="{{ $theme->layout_type }}"
                 data-status="{{ $theme->status }}"
                 data-type="{{ $theme->is_free ? 'free' : 'paid' }}"
                 data-name="{{ strtolower($theme->name) }}"
                 data-rating="{{ $theme->rating }}"
                 data-downloads="{{ $theme->downloads_count }}">
                ...
                <div class="theme-preview">
                    ...
                    <div class="theme-image">
                        ...
                        <div class="price-badge">
                            ...
                            @else
                                <span class="badge bg-warning text-dark">${{ number_format($theme->price, 2) }}</span>
                            @endif
                        </div>
                        ...
                        <div class="theme-overlay">
                            <div class="theme-actions">
                                @if($theme->demo_url)
                                    <a href="{{ $theme->demo_url }}" target="_blank" class="btn btn-sm btn-light" title="Live Preview">
                                        <i class="fas fa-external-link-alt"></i>
                                    </a>
                                @endif
                                <a href="{{ route('super-admin.themes.show', $theme) }}" class="btn btn-sm btn-light" title="View Details">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="{{ route('super-admin.themes.edit', $theme) }}" class="btn btn-sm btn-light" title="Edit Theme">
                                ...
                                <button class="btn btn-sm btn-light toggle-status-btn" 
                                        ...
                                        title="Toggle Status">
                                    <i class="fas {{ $theme->status === 'active' ? 'fa-pause' : 'fa-play' }}"></i>
                                </button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="theme-info">
                        <div class="theme-header">
                            ...
                            <div class="theme-meta">
                                <span class="category-badge">{{ $theme->category_name }}</span>
                                @if($theme->layout_type)
                                    <span class="layout-badge">{{ $theme->layout_type_name }}</span>
                                @endif
                            </div>
                        </div>
                        
                        <p class="theme-description">{{ Str::limit($theme->description, 100) }}</p>
                            ...
                            <div class="rating">
                                @if($theme->rating)
                                    @foreach($theme->rating_stars as $star)
                                        <i class="{{ $star }}"></i>
                                    @endforeach
                                    <span class="rating-text">{{ $theme->rating }}</span>
                                @else
                        ...
                        @if($theme->features && count($theme->features) > 0)
                            <div class="theme-features">
                                ...
                                @endforeach
                                @if(count($theme->features) > 3)
                                    <span class="more-features">+{{ count($theme->features) - 3 }} more</span>
                                @endif
                            </div>
                        @endif
                        ...
                        <div class="theme-footer">
                            ...
                            <div class="usage">
                                ...
                                <span>{{ $theme->companies->count() }} companies</span>
                            </div>
                        </div>
                        ...
                        <div class="theme-actions-bottom">
                            <div class="btn-group w-100">
                                <a href="{{ route('super-admin.themes.show', $theme) }}" class="btn btn-outline-primary">
                                    Details
                                </a>
                                <a href="{{ route('super-admin.themes.edit', $theme) }}" class="btn btn-outline-secondary">
                                    Edit
                                </a>
