                    ...
                    <div class="mt-auto">
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <div class="text-end">
                                    <small class="text-success fw-bold">
                                        <i class="fas fa-rupee-sign"></i> Save ₹{{ number_format($product->price - $product->discount_price, 2) }}
                                    </small>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="product-actions">
                            ...
                            <div class="d-flex gap-2">
                                ...
                                @if($product->isInStock())
                                    <button onclick="addToCartWithQuantity({{ $product->id }})" class="btn btn-danger btn-sm flex-grow-1">
