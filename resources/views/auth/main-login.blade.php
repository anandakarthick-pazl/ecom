...
<head>
    ...
    <title>Login - Herbal Ecom SaaS Platform</title>
        ...
        <div class="max-w-md w-full space-y-8">
                ...
                <div class="mt-8 text-center space-y-4">
                    <div class="border-t border-gray-200 pt-6">
                        ...
                        <p class="text-xs text-gray-500 mt-2">
                            Visit the company's domain directly (e.g., organicnature.local:8000)
                        </p>
                    </div>
            ...
            <div class="grid grid-cols-2 gap-4 mt-8">
                ...
                <div class="bg-white/80 backdrop-blur-sm rounded-xl p-4 text-center border border-gray-200">
                    ...
                    <div class="text-sm font-semibold text-gray-900">New Company?</div>
                    <a href="{{ route('home') }}#register" class="text-xs text-primary-600 hover:underline">Register Store</a>
                </div>
            </div>
        </div>
    </div>
