<?php $__env->startSection('title', 'Order Success - Herbal Bliss'); ?>

<?php $__env->startSection('content'); ?>
<!-- Razorpay Payment Modal -->
<?php if(session('initiate_payment') && session('payment_method') === 'razorpay' && $order->payment_status !== 'paid'): ?>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    ...
                    <p class="mb-3">Amount to Pay: <strong class="text-primary">₹<?php echo e(number_format($order->total, 2)); ?></strong></p>
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
                    ...
                    <div class="alert alert-success border-0 shadow-sm">
                        <div class="row align-items-center">
                            <div class="col-md-6 text-md-start">
                                ...
                                <span class="h4 text-primary fw-bold"><?php echo e($order->order_number); ?></span>
                            </div>
                            <div class="col-md-6 text-md-end">
                                <strong class="text-success">📅 Order Date:</strong><br>
                                <span class="h6"><?php echo e($order->created_at->format('M d, Y h:i A')); ?></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="border-start border-primary border-3 ps-3">
                                ...
                                <p class="mb-1"><i class="fas fa-phone text-muted"></i> <?php echo e($order->customer_mobile); ?></p>
                                <?php if($order->customer_email): ?>
                                    <p class="mb-1"><i class="fas fa-envelope text-muted"></i> <?php echo e($order->customer_email); ?></p>
                                <?php endif; ?>
                                <p class="mb-1"><i class="fas fa-map-marker-alt text-muted"></i> <?php echo e($order->delivery_address); ?></p>
                                <p class="mb-0"><?php echo e($order->city); ?>, <?php echo e($order->state); ?> <?php echo e($order->pincode); ?></p>
                            </div>
                            ...
                            <div class="mt-3">
                                ...
                                <div class="alert alert-info">
                                    <small><?php echo e($order->notes); ?></small>
                                </div>
                            </div>
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="order-items">
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-3 p-2 bg-light rounded">
                                    <div class="flex-grow-1">
                                        <strong class="text-dark"><?php echo e($item->product_name); ?></strong><br>
                                        <small class="text-muted">
                                            <i class="fas fa-boxes"></i> Qty: <?php echo e($item->quantity); ?> × 
                                            <i class="fas fa-rupee-sign"></i><?php echo e(number_format($item->price, 2)); ?>

                                            <?php if($item->tax_percentage > 0): ?>
                                                <br><i class="fas fa-percent"></i> Tax: <?php echo e($item->tax_percentage); ?>% = 
                                                <i class="fas fa-rupee-sign"></i><?php echo e(number_format($item->tax_amount, 2)); ?>

                                            <?php endif; ?>
                                        </small>
                                    </div>
                                    <div class="text-end">
                                        <strong class="text-success"><i class="fas fa-rupee-sign"></i><?php echo e(number_format($item->total, 2)); ?></strong>
                                    </div>
                                </div>
                            ...
                            <div class="border-top pt-3">
                                <div class="d-flex justify-content-between mb-2">
                                    ...
                                    <span><i class="fas fa-rupee-sign"></i><?php echo e(number_format($order->subtotal, 2)); ?></span>
                                </div>
                                
                                <?php if($order->discount > 0): ?>
                                <div class="d-flex justify-content-between mb-2">
                                    <span class="text-success"><i class="fas fa-percent"></i> Discount:</span>
                                    <span class="text-success">-<i class="fas fa-rupee-sign"></i><?php echo e(number_format($order->discount, 2)); ?></span>
                                </div>
                                <?php endif; ?>
                                
                                <div class="d-flex justify-content-between mb-2">
                                    <span><i class="fas fa-receipt"></i> CGST:</span>
                                    <span><i class="fas fa-rupee-sign"></i><?php echo e(number_format($order->cgst_amount, 2)); ?></span>
                                </div>
                                
                                <div class="d-flex justify-content-between mb-2">
                                    <span><i class="fas fa-receipt"></i> SGST:</span>
                                    <span><i class="fas fa-rupee-sign"></i><?php echo e(number_format($order->sgst_amount, 2)); ?></span>
                                </div>
                                ...
                                <div class="d-flex justify-content-between mb-2">
                                    ...
                                    <span>
                                        ...
                                        <?php else: ?>
                                            <i class="fas fa-rupee-sign"></i><?php echo e(number_format($order->delivery_charge, 2)); ?>
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <strong class="text-primary fs-5"><i class="fas fa-rupee-sign"></i><?php echo e(number_format($order->total, 2)); ?></strong>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-4">
                    <div class="card text-center">
                        <div class="card-body">
                            ...
                            ?>
                            <i class="<?php echo e($paymentIcon); ?> fa-2x text-<?php echo e($paymentColor); ?> mb-2"></i>
                            <h6>Payment Method</h6>
                            <small class="text-muted"><?php echo e($paymentName); ?></small>
                            <?php if($order->payment_status): ?>
                                <br>
                                <span class="badge bg-<?php echo e($order->payment_status_color); ?> mt-1">
            ...
            <div class="text-center mt-4">
                <a href="<?php echo e(route('track.order')); ?>" class="btn btn-primary btn-lg me-2">
                    <i class="fas fa-search"></i> Track Your Order
                </a>
                <a href="<?php echo e(route('shop')); ?>" class="btn btn-outline-primary btn-lg">
            ...
            <div class="alert alert-light border-0 shadow-sm mt-4">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 text-md-end mt-2 mt-md-0">
                        <a href="https://wa.me/?text=Just ordered amazing herbal products! Check them out: <?php echo e(route('shop')); ?>" 
 ...
 * Last Updated: <?php echo e(date('Y-m-d H:i:s')); ?>
...
console.log('%cTimestamp: <?php echo e(date("Y-m-d H:i:s")); ?>', 'color: gray;');
...
(function() {
    ...
    window.verifyPayment = function(paymentResponse) {
        ...
        utils.makeRequest(
            '<?php echo e(route("razorpay.verify-payment")); ?>',
            'POST',
            data,
            function(response) {
    ...
    function initPaymentSystem() {
        ...
        if (payButton) {
            payButton.addEventListener('click', function() {
                ...
                utils.makeRequest(
                    '<?php echo e(route("razorpay.create-order")); ?>',
                    'POST',
                    orderData,
                    function(response) {
                        ...
                        if (response.success) {
                            ...
                            const razorpayOptions = {
                                ...
                                name: '<?php echo e($globalCompany->company_name ?? "Your Store"); ?>',
                                ...
                                theme: {
                                    color: '<?php echo e($globalCompany->primary_color ?? "#2c3e50"); ?>'
                                },
                                modal: {
                                    ondismiss: function() {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\source_code\herbal-ecom\resources\views/order-success.blade.php ENDPATH**/ ?>