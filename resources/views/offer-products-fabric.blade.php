...
@section('title', 'Offers - ' . ($globalCompany->company_name ?? 'Your Store'))

@section('content')
<!-- Offers Page with Fabric Theme -->
<section style="padding: 3rem 0; background: #f8f9fa; min-height: 80vh;">
    <div class="container">
        <div class="row mb-4">
            <div class="col-md-6">
                <h2 style="font-size: 2rem; font-weight: 700;">Special Offers</h2>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="text-center" style="padding: 4rem 0;">
                    <i class="fas fa-tags" style="font-size: 4rem; color: #ddd; margin-bottom: 1rem;"></i>
