    ...
    <div class="relative min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8">
            ...
            <div class="bg-white rounded-2xl shadow-2xl p-8 border border-gray-100">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="email" id="email" name="email" value="{{ old('email') }}" required
                                   class="w-full pl-12 pr-4 py-3 border-2 border-gray-200 rounded-xl focus:border-primary-500 focus:ring-0 transition-colors duration-200 @error('email') border-red-300 @enderror"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="password" id="password" name="password" required
                                   class="w-full pl-12 pr-12 py-3 border-2 border-gray-200 rounded-xl focus:border-primary-500 focus:ring-0 transition-colors duration-200 @error('password') border-red-300 @enderror"
                ...
                <div class="mt-8 text-center space-y-4">
                    <div class="border-t border-gray-200 pt-6">
                        <div class="bg-primary-50 rounded-xl p-4">
                            <div class="flex items-center justify-center space-x-2 text-primary-700">
                                ...
                                <span class="font-semibold">{{ $company->name }} Admin Panel</span>
                            </div>
                    ...
                    <div class="flex justify-center space-x-6 text-sm text-gray-500">
                        <a href="{{ route('shop') }}" class="hover:text-gray-700 flex items-center">
                            <i class="fas fa-shopping-bag mr-1"></i>
                            View Store
                        </a>
                        <a href="{{ url('/') }}" class="hover:text-gray-700 flex items-center">
            ...
            <div class="bg-white/80 backdrop-blur-sm rounded-xl p-4 text-center border border-gray-200">
                ...
                <div class="text-sm font-semibold text-gray-900">Secure Access</div>
                <div class="text-xs text-gray-500 mt-1">Protected by SSL encryption</div>
            </div>
        </div>
    </div>
