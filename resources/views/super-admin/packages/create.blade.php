                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <select class="form-select @error('billing_cycle') is-invalid @enderror" 
                                                ...
                                                @foreach(App\Models\SuperAdmin\Package::BILLING_CYCLES as $key => $name)
                                                    <option value="{{ $key }}" {{ old('billing_cycle') == $key ? 'selected' : '' }}>
                                                        {{ $name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        ...
                                        <div id="limits-container">
                                            @if(old('limits'))
                                                @foreach(old('limits') as $key => $value)
                                ...
                                <div class="card-body">
                                    <div class="package-preview-card" id="package-preview">
                                        <div class="text-center mb-3">
                                            <div class="popular-badge" style="display: none;">
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <span class="badge bg-info preview-billing">Monthly</span>
                                            </div>
                                            <h2 class="text-primary preview-price">$0.00</h2>
                                            <small class="text-success preview-trial" style="display: none;">
...
$(document).ready(function() {
    ...
    function updatePreview() {
        ...
        const description = $('#description').val() || 'Package description will appear here...';
        const price = $('#price').val() || '0';
        const billingCycle = $('#billing_cycle option:selected').text() || 'Monthly';
        const status = $('#status').val() || 'active';
        const isPopular = $('#is_popular').is(':checked');
        const trialDays = $('#trial_days').val() || '0';
