...
@section('page_actions')
    <div class="btn-group invoice-actions-group">
        ...
        <!-- Print Invoice -->
        <a href="{{ route('admin.orders.print-invoice', $order) }}?format={{ $defaultBillFormat }}&type=print" class="btn btn-secondary"
        ...
        <a href="{{ route('admin.orders.print-invoice', $order) }}?format={{ $defaultBillFormat }}&type=download" class="btn btn-secondary"
            title="Download {{ $formatLabel }}" download>
            <i class="fas {{ $formatIcon }}"></i> Download {{ $formatLabel }}
        </a>
                                ...
                                <table class="table table-sm mb-0">
                                    ...
                                    @if ($order->discount > 0)
                                        <tr>
                                            ...
                                            <td class="text-end text-success">-₹{{ number_format($order->discount, 2) }}
                                            </td>
                                        </tr>
                                    @endif
                                    <tr>
