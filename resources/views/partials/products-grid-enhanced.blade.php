    ...
    <div class="product-grid-enhanced">
        ...
        <div class="product-card-compact" data-product-id="{{ $product->id }}">
                ...
                <div class="product-badges">
                    <div>
                        @if($product->discount_percentage > 0)
                            <span class="badge badge-compact bg-danger">{{ $product->discount_percentage }}% OFF</span>
                        @endif
                    </div>
                    <div>
            ...
            <div class="product-content">
                ...
                <h6 class="product-title-compact">{{ $product->name }}</h6>
                ...
                @if($product->isInStock())
                    <div class="quantity-section mb-2">
                        ...
                        <div class="quantity-input-group">
                            <button type="button" class="quantity-btn quantity-decrease" onclick="decreaseQuantity({{ $product->id }})">
                            ...
                            <button type="button" class="quantity-btn quantity-increase" onclick="increaseQuantity({{ $product->id }}, {{ $product->stock }})">
                ...
                <div class="product-actions-compact">
                    <a href="{{ route('product', $product->slug) }}" class="btn btn-outline-primary btn-compact">
                        <i class="fas fa-eye"></i> View
                    </a>
                    @if($product->isInStock())
                        <button onclick="addToCartWithAnimation({{ $product->id }})" class="btn btn-primary btn-compact">
