                ...
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex align-items-center gap-2">
                        <span class="items-count-badge">
                            <i class="fas fa-shopping-cart"></i> <span id="itemsCount">{{ $estimate->items->count() }}</span> Items
                        </span>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <div class="alert alert-info {{ $estimate->items->count() > 0 ? 'd-none' : '' }}" id="noItemsAlert">
