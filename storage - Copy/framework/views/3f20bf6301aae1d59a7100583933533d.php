...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', '<?php echo e($globalCompany->company_name ?? "Your Store"); ?> - E-commerce Store'); ?></title>
    
    <!-- SEO Meta Tags -->
    <meta name="description" content="<?php echo $__env->yieldContent('meta_description', 'Discover quality products at <?php echo e($globalCompany->company_name ?? "Your Store"); ?>. Your trusted online shopping destination.'); ?>">
    <meta name="keywords" content="<?php echo $__env->yieldContent('meta_keywords', 'ecommerce, online shopping, products, <?php echo e(strtolower($globalCompany->company_name ?? "online store")); ?>'); ?>">
    
    <!-- Open Graph Tags -->
    <meta property="og:title" content="<?php echo $__env->yieldContent('og_title', '<?php echo e($globalCompany->company_name ?? "Your Store"); ?> - E-commerce Store'); ?>">
    <meta property="og:description" content="<?php echo $__env->yieldContent('og_description', 'Discover quality products at <?php echo e($globalCompany->company_name ?? "Your Store"); ?>. Your trusted online shopping destination.'); ?>">
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm fixed-top">
        <div class="container">
            <a class="navbar-brand" href="<?php echo e(route('shop')); ?>">
                <?php if($globalCompany->company_logo): ?>
                    <img src="<?php echo e(asset('storage/' . $globalCompany->company_logo)); ?>" 
                         alt="<?php echo e($globalCompany->company_name); ?>" 
                         style="height: 40px; width: auto; object-fit: contain;">
                <?php else: ?>
                    🏪 <?php echo e($globalCompany->company_name ?? 'Your Store'); ?>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('shop') ? 'active' : ''); ?>" href="<?php echo e(route('shop')); ?>">Home</a>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle <?php echo e(request()->routeIs('category') ? 'active' : ''); ?>" href="#" id="categoriesDropdown" role="button" data-bs-toggle="dropdown">
                            Categories
                        </a>
                        <ul class="dropdown-menu">
                            ...
                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li><a class="dropdown-item" href="<?php echo e(route('category', $category->slug)); ?>"><?php echo e($category->name); ?></a></li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('offer.products') ? 'active' : ''); ?>" href="<?php echo e(route('offer.products')); ?>">
                            <i class="fas fa-tags me-1"></i>Offer Products
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('track.order') ? 'active' : ''); ?>" href="<?php echo e(route('track.order')); ?>">Track Order</a>
                    </li>
                </ul>
                
                <!-- Search Form -->
                <form class="d-flex me-3" action="<?php echo e(route('search')); ?>" method="GET">
                    <input class="form-control me-2" type="search" name="q" placeholder="Search products..." value="<?php echo e(request('q')); ?>">
    ...
    <footer class="bg-dark text-white mt-5 py-4">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="<?php echo e(route('shop')); ?>" class="text-white-50">Home</a></li>
                        <li><a href="<?php echo e(route('track.order')); ?>" class="text-white-50">Track Order</a></li>
                ...
                <div class="col-md-4">
                    <h5>Contact Info</h5>
                    <?php if($globalCompany->company_phone): ?>
                        <p class="mb-1"><i class="fas fa-phone"></i> <?php echo e($globalCompany->company_phone); ?></p>
                    <?php endif; ?>
                    <p class="mb-1"><i class="fas fa-envelope"></i> <?php echo e($globalCompany->company_email ?: 'info@example.com'); ?></p>
                    <?php if($globalCompany->company_address): ?>
                        <p class="mb-1"><i class="fas fa-map-marker-alt"></i> <?php echo e($globalCompany->company_address); ?></p>
                    <?php endif; ?>
                    <div class="mt-3">
            ...
            <div class="text-center">
                <p>&copy; <?php echo e(date('Y')); ?> <?php echo e($globalCompany->company_name ?? 'Your Store'); ?>. All rights reserved.</p>
            </div>
        </div>
    </footer>
...
<?php /**PATH D:\source_code\herbal-ecom\resources\views/layouts/app.blade.php ENDPATH**/ ?>